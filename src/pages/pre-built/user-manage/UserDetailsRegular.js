...
const UserDetailsPage = ({ match }) => {
  ...
  const [data] = contextData; ////khkjhkjhkjhkjhkjhkjhjk
            ...
            <BlockBetween>
              <BlockHeadContent>
                <BlockTitle tag="h3" page>
                  Users / <strong className="text-primary small">{user.username}</strong>
                </BlockTitle>
                <BlockDes className="text-soft">
                  <ul className="list-inline">
                    ...
                    <li>
                      Last Login: <span className="text-base">{user.updatedAt}</span>
                    </li>
                  </ul>
                </BlockDes>
              </BlockHeadContent>
                  ...
                  <div className="card-inner">
                    <Block>
                      ...
                      <div className="profile-ud-list">
                        ...
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">phone_number</span>
                        ...
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            ...
                            <span className="profile-ud-value">{user.status}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">notif_email</span>
                            <span className="profile-ud-value">{user.notif_email}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">notif_sms</span>
                            <span className="profile-ud-value">{user.notif_sms}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">total_referrals</span>
                            <span className="profile-ud-value">{user.total_referrals}</span>
                          </div>
                        </div>
                      </div>
                      {/* </Block>
                    ...
                    <Block>
                      ...
                      <div className="profile-ud-list">
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">referral_code</span>
                            <span className="profile-ud-value">{user.referral_code}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">refree_code</span>
                            <span className="profile-ud-value">{user.refree_code}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">total_orders</span>
                            <span className="profile-ud-value">{user.total_orders}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">wallet_balance</span>
                            <span className="profile-ud-value">{user.wallet_balance}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">allergens</span>
                            <span className="profile-ud-value">{user.allergens}</span>
                          </div>
                        </div>
                        <div className="profile-ud-item">
                          <div className="profile-ud wider">
                            <span className="profile-ud-label">favourite</span>
                            <span className="profile-ud-value">{user.favourite}</span>
                          </div>
                        </div>
                      </div>
                    </Block>
                ...
                <Sidebar toggleState={sideBar}>
                  <div className="card-inner">
                    <div className="user-card user-card-s2 mt-5 mt-xxl-0">
                      <UserAvatar className="lg" theme="primary" text={findUpper(user.username)} />
                      <div className="user-info">
                        <div className="badge badge-outline-light badge-pill ucap">{user.role_id == 1 ? 'Customer' : 'Admin'}</div>
                        <h5>{user.username}</h5>
                    ...
                    <div className="profile-balance">
                      <div className="profile-balance-group gx-4">
                        <div className="profile-balance-sub">
                          ...
                          <div className="profile-balance-subtitle">phone_number</div>
                        </div>
                        <div className="profile-balance-sub">
                          ...
                          <div className="profile-balance-amount">
                            <div className="number">{user.address}</div>
                          </div>
                          <div className="profile-balance-subtitle">address</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <Row className="text-center">
                      <Col size="4">
                        <div className="profile-stats">
                          <span className="amount">{user.total_orders}</span>
                          <span className="sub-text">Total Order</span>
                        </div>
                      </Col>
                      <Col size="4">
                        <div className="profile-stats">
                          <span className="amount">{user.referral_code}</span>
                          <span className="sub-text">referral_code</span>
                        </div>
                      </Col>
                      <Col size="4">
                        <div className="profile-stats">
                          <span className="amount">{user.total_referrals}</span>
                          <span className="sub-text">Total Referrals</span>
                        </div>
                      </Col>
                    </Row>
                  </div>
                  <div className="card-inner">
                    ...
                    <Row className="g-3">
                      ...
                      <Col size="6">
                        ...
                        <span
                          className={`lead-text text-${user.status === "block"
                            ? "block"
                            : "unblock"}`}
                        >
